...
public interface Sign {
    ...
    interface Native {
         ...
         */
        boolean cryptoSignInit(StateCryptoSign state);
         ...
         */
        boolean cryptoSignUpdate(StateCryptoSign state, byte[] chunk, long chunkLength);
         ...
         */
        boolean cryptoSignFinalCreate(StateCryptoSign state, byte[] sig, Pointer sigLen, byte[] sk);
         ...
         * @return True if successfully signed completely.
         */
        boolean cryptoSignFinalVerify(StateCryptoSign state, byte[] sig, byte[] pk);
