 ...
 */
public class CloudAgentEvents extends WebSocketAgentConnection implements AgentEvents {
    Logger log = Logger.getLogger(CloudAgentEvents.class.getName());
    String tunnel;
    ...
    public CloudAgentEvents(String serverAddress, byte[] credentials, P2PConnection p2p, int timeout) {
