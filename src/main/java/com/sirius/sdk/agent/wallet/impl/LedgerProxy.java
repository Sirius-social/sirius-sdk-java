...
public class LedgerProxy extends AbstractLedger  {
    ...
    @Override
    public Pair<Boolean, String> registerSchema(String poolName, String submitterDid, String data) {
        return null;
    }

    @Override
    public Pair<Boolean, String> registerCredDef(String poolName, String submitterDid, String data) {
        return null;
    }
    ...
    @Override
    public String signAndSubmit(String poolName, String submitterDid, String request) {
        return null;
    }
