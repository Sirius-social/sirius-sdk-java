...
public abstract class AbstractLedger {
    ...
    /**
     * Overload method {@link #writeNum(String poolName, String submitterDid, String targetDid,
     * String verKey, String alias, NYMRole role)}
     */

    public Pair<Boolean, String> writeNum(String poolName, String submitterDid, String targetDid,
                                          String verKey, String alias) {
     ...
     */
    public  String submitAction(String poolName, String request, List<String> nodes){
     ...
     * Overload method {@link #}
     */
    public  String submitAction(String poolName, String request){
        return submitAction( poolName,  request, null);
    }
    ...
    /**
     * Overload method {@link #buildNymRequest(String submitterDid, String targetDid, String verKey,
     *                                            String alias, NYMRole role)}
     */
    public  String buildNymRequest(String submitterDid, String targetDid, String verKey,
                                   String alias){
        return buildNymRequest( submitterDid,  targetDid,  verKey,
                 alias,  null);
    }
     ...
     */
    public  String buildNymRequest(String submitterDid, String targetDid, String verKey){
        return buildNymRequest( submitterDid,  targetDid,  verKey,  null);
    }
     ...
     *                                            String alias, NYMRole role)}
     */
    public  String buildNymRequest(String submitterDid, String targetDid){
        return buildNymRequest( submitterDid,  targetDid,  null);
    }
    ...
    /**
     * Overload method {@link #buildAttribRequest(String submitterDid, String targetDid, String xhash, String raw)}
     */
    public  String buildAttribRequest(String submitterDid, String targetDid, String xhash, String raw){
     ...
     * Overload method {@link #buildAttribRequest(String submitterDid, String targetDid, String xhash, String raw)}
     */
    public  String buildAttribRequest(String submitterDid, String targetDid, String xhash){
        return buildAttribRequest( submitterDid,  targetDid,  xhash, null);
    }

    /**
     * Overload method {@link #buildAttribRequest(String submitterDid, String targetDid, String xhash, String raw)}
     */
    public  String buildAttribRequest(String submitterDid, String targetDid){
        return buildAttribRequest( submitterDid,  targetDid, null);
    }
    ...
    /**
     * Overload method {@link #buildGetAttribRequest(String submitterDid, String targetDid, String raw, String xhash, String enc)}
     */
    public  String buildGetAttribRequest(String submitterDid, String targetDid, String raw, String xhash){
     ...
     * Overload method {@link #buildGetAttribRequest(String submitterDid, String targetDid, String raw, String xhash, String enc)}
     */
    public  String buildGetAttribRequest(String submitterDid, String targetDid, String raw){
        return  buildGetAttribRequest( submitterDid,  targetDid,  raw, null);
    }

    /**
     * Overload method {@link #buildGetAttribRequest(String submitterDid, String targetDid, String raw, String xhash, String enc)}
     */
    public  String buildGetAttribRequest(String submitterDid, String targetDid){
        return  buildGetAttribRequest( submitterDid,  targetDid, null);
    }
    ...
    /**
     * Overload method {@link #buildTxnAuthorAgreementRequest(String submitterDid, String text, String version,
     *                                                           Integer ratification_ts, Integer retirement_ts)}
     */
    public  String buildTxnAuthorAgreementRequest(String submitterDid, String text, String version,
                                                          Integer ratification_ts){
        return buildTxnAuthorAgreementRequest( submitterDid,  text,  version,
     ...
     */
    public  String buildTxnAuthorAgreementRequest(String submitterDid, String text, String version){
        return buildTxnAuthorAgreementRequest( submitterDid,  text,  version,null);
    }
    ...
    /**
     * Overload method {@link #buildGetTxnAuthorAgreementRequest(String submitterDid, String data)}
     */

    public  String buildGetTxnAuthorAgreementRequest(String submitterDid){
